...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MachineUser', function() {
      beforeEach(function() {
        instance = new AccountsApi.MachineUser();
      });

      it('should create an instance of MachineUser', function() {
        // TODO: update the code to test MachineUser
        expect(instance).to.be.a(AccountsApi.MachineUser);
      });
