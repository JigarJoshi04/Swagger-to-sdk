...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RoleListLinks', function() {
      beforeEach(function() {
        instance = new AccountsApi.RoleListLinks();
      });

      it('should create an instance of RoleListLinks', function() {
        // TODO: update the code to test RoleListLinks
        expect(instance).to.be.a(AccountsApi.RoleListLinks);
      });
