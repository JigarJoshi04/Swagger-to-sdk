...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CustomerListLinks', function() {
      beforeEach(function() {
        instance = new AccountsApi.CustomerListLinks();
      });

      it('should create an instance of CustomerListLinks', function() {
        // TODO: update the code to test CustomerListLinks
        expect(instance).to.be.a(AccountsApi.CustomerListLinks);
      });
