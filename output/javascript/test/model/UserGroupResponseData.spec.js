...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserGroupResponseData', function() {
      beforeEach(function() {
        instance = new AccountsApi.UserGroupResponseData();
      });

      it('should create an instance of UserGroupResponseData', function() {
        // TODO: update the code to test UserGroupResponseData
        expect(instance).to.be.a(AccountsApi.UserGroupResponseData);
      });
