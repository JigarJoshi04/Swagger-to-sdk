...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PagedUserGroupListResponseLinks', function() {
      beforeEach(function() {
        instance = new AccountsApi.PagedUserGroupListResponseLinks();
      });

      it('should create an instance of PagedUserGroupListResponseLinks', function() {
        // TODO: update the code to test PagedUserGroupListResponseLinks
        expect(instance).to.be.a(AccountsApi.PagedUserGroupListResponseLinks);
      });
