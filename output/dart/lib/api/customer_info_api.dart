...
class CustomerInfoApi {
  ...
  Future<RoleList> getRoles(String customerId, { String page[cursor], int page[size] }) async {
    ...
    // create path and map variables
    String path = "/customers/{customerId}/roles".replaceAll("{format}","json").replaceAll("{" + "customerId" + "}", customerId.toString());
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'RoleList') as RoleList ;
    } else {
      return null;
    }
  }
