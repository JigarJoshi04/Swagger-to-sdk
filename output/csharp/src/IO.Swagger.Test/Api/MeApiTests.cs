...
namespace IO.Swagger.Test
{
    ...
    public class MeApiTests
    {
        ...
        /// </summary>
        [Test]
        public void GetMeUsergroupsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string pageCursor = null;
            //int? pageSize = null;
            //var response = instance.GetMeUsergroups(pageCursor, pageSize);
            //Assert.IsInstanceOf<UserGroupList> (response, "response is UserGroupList");
        }
    }
