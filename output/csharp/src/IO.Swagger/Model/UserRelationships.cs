...
namespace IO.Swagger.Model
{
        ...
        public partial class UserRelationships :  IEquatable<UserRelationships>, IValidatableObject
    {
        ...
        public UserRelationships(UserGroupRelationship belongsTo = default(UserGroupRelationship))
        {
        ...
        public UserGroupRelationship BelongsTo { get; set; }
        ...
        public bool Equals(UserRelationships input)
        {
            ...
            return 
                (
                    ...
                    (this.BelongsTo != null &&
                    this.BelongsTo.Equals(input.BelongsTo))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BelongsTo != null)
                    hashCode = hashCode * 59 + this.BelongsTo.GetHashCode();
                return hashCode;
            }
        }
